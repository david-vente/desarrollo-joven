...
function verificarParidad(numero) {
    // Tu código aquí
    if (numero % 2 === 0) {console.log("El número es par")} else {console.log("El número es impar")}
}
...
function imprimirPares(numero) {
    // Tu código aquí
    for (let par = 0; par<numero ;par = par + 2 ){
        console.log(par)
    } 
}
...
function evaluarNumeros(a, b, c) {
    ...
    // Asumiendo que a, b y c son distintos de 0
